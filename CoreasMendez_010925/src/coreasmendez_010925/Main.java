...
public class Main {
    ...
    public static void matriz(){
        ...
        System.out.println("Ingrese los valore4s para una matriz 3x3");
        
        //SE RECORRE PRIMERO LAS FILAS CON UNA ESTRUCTURA DE CONTROL ITERATIVA
        //DE TIPO FOR
        for(int i=0; i<matriz.length; i++){
            //EN CADA ITEsssRACION SE DEBERA OBTENER LA CANTIDAD DE ELEMENTOS
            //QUE EXISTE EM EL ARREGLO (CANTIDAD COLUMNAS)
            total_elementos += matriz[i].length;
            
            //SE RECORRE LAS COLUMNAS DE LA MATRIZ CON UNA ESTRUCTURA DE CONTROL
            //ITERATIVA DE TIPO FOR
            //DEBIDO A QUE DEBEMOS PBTENER EL VALOR DE CADA CELDA (FILA Y COLUMNA)
